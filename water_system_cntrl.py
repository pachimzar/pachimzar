...
global n_A1
global n_A2
global Soil_Moist_A0
global Soil_Moist_A1
global Soil_Moist_A2
global tstrt
global mstrt
global bstrt
global tsm_beg
...
yag = yagmail.SMTP("pachimzar+waterpi@gmail.com", "@Dracula7")
...
try:
   ...
   while True:
       ...
       if Soil_Moist_A0 > lower_limit_A0 and n_A0 > 0:
            ...
            tsm_end = Soil_Moist_A0 # Soil moisture at end of watering top shelf
